...
public class BlogDAO {
    ...
    public void update(int id,String image,String name, String content, String time) throws Exception{
        
        String query="update Blog set [name]=N'"+name+"', content=N'"+content+"', [time]='"+time+"',image='"+image+"' where blogId="+id;
        Connection conn=new DBContext().getConnection();
        conn.prepareStatement(query).executeUpdate();
        conn.close();
    }
